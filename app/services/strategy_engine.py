    ...
    def generate_signal(self, analysis: Dict[str, Any], risk_percent: float) -> Dict[str, Any]:
        ...
        if buy_score > sell_score and buy_score >= 2:
            ...
            return {
                ...
                "reasoning": f"Bullish setup. Price near support at {support}. Trend is {trend}. RSI: {rsi}"
            }
            ...
            return {
                ...
                "reasoning": f"Bearish setup. Price near resistance at {resistance}. Trend is {trend}. RSI: {rsi}"
            }
        
        else:
            return {
                "action": "WAIT",
                "reasoning": f"No clear signal. Trend: {trend}, RSI: {rsi}. Support: {support}, Resistance: {resistance}",
                "confidence": 0.3
            }
